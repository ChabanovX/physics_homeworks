...
Time calculation was omitted due to simplicity.
$$ S_{[0:4]} = (0 + 0 \cdot 4 + 1 \cdot \frac{4^2}{2})m = 8m $$
$$ S_{[4:10]} = (8 + 4 \cdot 6 + 0 \cdot \frac{4^2}{2})m = 32m $$
$$ S_{[10:18]} = (32 + 4 \cdot 8 - 0.5 \cdot \frac{4^2}{2})m = 48m $$
So the displacement is $S(t) = \begin{cases} 8 & 0 \leq t \leq 4 \\ 32 & 4 < t \leq 10 \\ 48 & 10 < t \leq 18 \end{cases}$.
\newpage %?
