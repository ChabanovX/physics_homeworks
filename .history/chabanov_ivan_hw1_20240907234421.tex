...
$$ S_{[0:4]} = 0 + 0 \cdot t + 1 \cdot \frac{t^2}{2} = (0 + 0 \cdot 4 + 1 \cdot \frac{4^2}{2})m = 8m $$
$$ S_{[4:10]} = x = (8 + 4 \cdot 6 + 0 \cdot \frac{4^2}{2})m = 32m $$
$$ S_{[10:18]} = x = (32 + 4 \cdot 8 - 0.5 \cdot \frac{4^2}{2})m = 48m $$
