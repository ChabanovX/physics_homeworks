...
Let us define the coordinate function on the interval a:b as $ x(t)_{[a:b]} $. We already got the functions over the intervals in the displacement section, so let's use them.
