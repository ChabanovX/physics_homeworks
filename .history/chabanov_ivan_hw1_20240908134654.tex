...
But still we can not plot the graph using this functions as we have to transfer time in the future for functions. For example, $x(t)_{[4:10]}$ should be $x(t)_{[4:10]}$
\newpage %?
