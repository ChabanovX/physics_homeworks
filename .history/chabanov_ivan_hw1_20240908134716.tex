...
But still we can not plot the graph using this functions as we have to transfer time in the future for functions. For example, $x(t)_{[4:10]}$ should be $x(t-4)_{[4:10]}$ as the body started to move this way only 
\newpage %?
