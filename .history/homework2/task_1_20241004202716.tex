...
$$ v_{\text{terminal of Jeep}} = \sqrt{\frac{2 \cdot m \cdot 9.8 \, \frac{\text{kg}}{s^2}}{0.5 \cdot C_d \cdot 1.007 \frac{kg}{m^3} \cdot 2.58 \, m^2}} $$

$$ v_{\text{terminal of Dodge}} = \sqrt{\frac{2 \cdot m \cdot 9.8 \, \frac{\text{kg}}{s^2}}{0.5 \cdot C_d \cdot 1.007 \frac{kg}{m^3} \cdot 2.41 \, m^2}} $$

$$ v_{\text{terminal of Subaru}} = \sqrt{\frac{2 \cdot m \cdot 9.8 \, \frac{\text{kg}}{s^2}}{0.5 \cdot C_d \cdot 1.007 \frac{kg}{m^3} \cdot 2.225}} $$