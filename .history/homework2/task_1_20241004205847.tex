...
\begin{equation}
    \label{eq:freefall}
    F_d = C_d \cdot \rho \cdot v^2 \cdot A
\end{equation}
...
$$ v_{\text{terminal of Jeep}} = \sqrt{\frac{2 \cdot 2000 \, kg \cdot 9.8 \, \frac{\text{kg}}{s^2}}{0.5 \cdot 0.5 \cdot 1.007 \frac{kg}{m^3} \cdot 2.58 \, m^2}} \approx \boxed{115.0 \frac{m}{s}}$$

$$ v_{\text{terminal of Dodge}} = \sqrt{\frac{2 \cdot 2450 \, kg \cdot 9.8 \, \frac{\text{kg}}{s^2}}{0.5 \cdot 0.38 \cdot 1.007 \frac{kg}{m^3} \cdot 2.41 \, m^2}}  \approx \boxed{139.4 \frac{m}{s}}$$ 

$$ v_{\text{terminal of Subaru}} = \sqrt{\frac{2 \cdot 1550 \, kg \cdot 9.8 \, \frac{\text{kg}}{s^2}}{0.5 \cdot 0.33 \cdot 1.007 \frac{kg}{m^3} \cdot 2.225 \, m^2}} \approx \boxed{122.4 \frac{m}{s}}$$ 
