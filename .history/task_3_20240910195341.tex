...
$$t_{\text{going for bottle}} = \frac{S}{v_1 - v_{\text{}}}$$

Substitute equations \eqref{eq:1} and \eqref{eq:2}:
$$t_{\text{going for bottle}} = \frac{t_{\text{going from bottle}} \cdot (\Vec{v}_{\text{boat}} - \Vec{v}_{\text{river}}) + 5km}{\Vec{v}_{\text{boat}} + \Vec{v}_{\text{river}}}$$
