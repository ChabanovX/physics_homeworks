...
\]
where $w_0, w_1, \dots, w_n$ — коэффициенты модели, а $x_1, x_2, \dots, x_n$ — признаки.
\\ ---
\begin{enumerate}
...
$$ S_{[t_1: t_3]} = S_{[t_0: t_3]} - S_{[t_0: t_1]} = S_{[0: 18]} - S_{[0: 4]} = (48 - 8)m = \boxed{40m} $$
...
$$ v_{av[t_1: t_3]} = \frac{S_{[t_1: t_3]}}{t_3 - t_1} = \frac{40m}{(18 - 4)s} \approx \boxed{2.86m/s} $$

% Pushes the following content to the bottom of the page 
